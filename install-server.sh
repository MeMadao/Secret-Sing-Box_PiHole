...
download_rule_sets() {
    ...
    wget -O /usr/local/bin/rsupdate https://raw.githubusercontent.com/MeMadao/Secret-Sing-Box_PiHole/master/ruleset-update.sh
...
add_sbmanager() {
    ...
    if [[ "${language}" == "1" ]]
    then
        wget -O /usr/local/bin/sbmanager https://raw.githubusercontent.com/MeMadao/Secret-Sing-Box_PiHole/master/sb-manager.sh
    else
        wget -O /usr/local/bin/sbmanager https://raw.githubusercontent.com/MeMadao/Secret-Sing-Box_PiHole/master/sb-manager-en.sh
    fi
